...
stat.hs.plot <- plot_usmap(regions = "counties",                   
                              #regions = "counties", for county level summary
    data = data, 
    values = "hs_grad", exclude = c("Hawaii", "Alaska"), color = "black") + 
    scale_fill_gradient(
      low = "white", high = "red", 
      name = "High school grad percentage", 
      label = scales::comma) + 
    labs(title = "aCounties hs_grad rate", subtitle = "Continental US Counties") +
    theme(legend.position = "right")

stat.hs.plot
```
Most counties has a relatively similar (high) hs_grad rate, except for some counties down south which has a lower pct.
...
stat.ba.plot <- plot_usmap(regions = "counties",                   
                              #regions = "counties", for county level summary
    data = data, 
    values = "bachelors", exclude = c("Hawaii", "Alaska"), color = "black") + 
    scale_fill_gradient(
      low = "white", high = "red", 
      name = "High school grad percentage", 
      label = scales::comma) + 
...
stat.ba.plot
```
There are way more variations with bachelors though
